...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'LuxeStore'); ?> | LuxeStore</title>
...
<nav class="navbar">
    <a href="<?php echo e(route('home')); ?>" class="nav-brand">Luxe<span>Store</span></a>
    <ul class="nav-links">
    ...
    <div class="nav-actions">
        ...
        <a href="<?php echo e(route('shop')); ?>?search=" class="nav-icon" title="Search"><i class="fas fa-search"></i></a>
        <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('cart')); ?>" class="nav-icon" title="Cart">
                <i class="fas fa-shopping-bag"></i>
                <?php try { $cartCount = auth()->user()->cart ? auth()->user()->cart->items->count() : 0; } catch (\Exception $e) { $cartCount = 0; } ?>
                <?php if($cartCount > 0): ?><span class="cart-badge"><?php echo e($cartCount); ?></span><?php endif; ?>
            </a>
            <div class="dropdown" id="user-dropdown">
                <a href="#" class="nav-icon" onclick="toggleDropdown(event)"><i class="fas fa-user"></i></a>
                <div class="dropdown-menu">
                    <?php if(auth()->user()->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-tachometer-alt fa-fw"></i> Admin Panel</a>
                    <?php elseif(auth()->user()->isStaff()): ?>
                        <a href="<?php echo e(route('staff.dashboard')); ?>"><i class="fas fa-tasks fa-fw"></i> Staff Panel</a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('profile')); ?>"><i class="fas fa-user-circle fa-fw"></i> Profile</a>
                    <a href="<?php echo e(route('orders.index')); ?>"><i class="fas fa-box fa-fw"></i> My Orders</a>
        ...
        <?php else: ?>
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn btn-gold btn-sm">Register</a>
        <?php endif; ?>
    </div>
</nav>
...
<footer>
    <div class="footer-grid">
        ...
        <div class="footer-col">
            ...
            <ul>
                ...
                <li><a href="<?php echo e(route('shop')); ?>?sort=newest">New Arrivals</a></li>
                <li><a href="<?php echo e(route('shop')); ?>?is_featured=1">Featured</a></li>
            </ul>
        </div>
        <div class="footer-col">
            <h4>Info</h4>
    ...
    <div class="footer-bottom">
        &copy; <?php echo e(date('Y')); ?> LuxeStore. All rights reserved.
    </div>
</footer>
...
</html><?php /**PATH C:\Users\vesot\Downloads\Telegram Desktop\LRV\Laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>